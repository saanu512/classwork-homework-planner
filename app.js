...
function navBar(){return `<nav aria-label="Main navigation"><button data-page="today"><span class="navIcon" aria-hidden="true">⌂</span><span class="navLabel">Today</span></button><button data-page="homework"><span class="navIcon" aria-hidden="true">✓</span><span class="navLabel">Homework</span></button><button data-page="syllabus"><span class="navIcon" aria-hidden="true">◈</span><span class="navLabel">Syllabus</span></button><button data-page="ai"><span class="navIcon" aria-hidden="true">✦</span><span class="navLabel">Gemini AI</span></button><button data-page="settings"><span class="navIcon" aria-hidden="true">⚙</span><span class="navLabel">Settings</span></button></nav>`}

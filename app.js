...
function freshStudentData(){return {profile:{name:'',email:'',roll:''},teachers:{},records:{},extras:[],changes:[],theme:(D.theme==='dark'||D.theme==='light3d'||D.theme==='dark3d')?D.theme:'light',schedule:null,reminders:[],syllabus:{},admin:{},settings:{reminderEnabled:true,oneDayBefore:true,reminderLead:60,lastSyncAt:0},_savedAt:0}}
...
function setTheme(){if(!['light','dark','light3d','dark3d'].includes(D.theme))D.theme='light';document.documentElement.dataset.theme=D.theme}

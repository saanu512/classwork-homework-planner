const CACHE='cwp-v40-startup-auth-fix1';
...
self.addEventListener('fetch',e=>{
  ...
  const isAppCode=u.pathname.endsWith('/app.js')||u.pathname.endsWith('/firebase.js')||u.pathname.endsWith('/index.html')||u.pathname.endsWith('/sw.js');
  if(isAppCode){
